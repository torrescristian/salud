  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-6">
        ...
        {showMedicationForm && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              <MedicationInput
                onMedicationSubmit={(name, withFood) => {
                  takeMedication(name, withFood);
        ...
        {showGlucoseForm && (
          <GlucoseMeasurementForm
            onSubmit={(value, context) => {
              addGlucoseMeasurement(value, context);
        ...
        {showPressureForm && (
          <PressureMeasurementForm
            onSubmit={(systolic, diastolic) => {
              addPressureMeasurement(systolic, diastolic);
              setShowPressureForm(false);
            }}
            onCancel={() => setShowPressureForm(false)}
        ...
        {showInsulinForm && (
          <InsulinEntryForm
            onSubmit={(dose, type, context, notes) => {
              addInsulinEntry(dose, type, context, notes);
              setShowInsulinForm(false);
            }}
            onCancel={() => setShowInsulinForm(false)}
          />
        )}
